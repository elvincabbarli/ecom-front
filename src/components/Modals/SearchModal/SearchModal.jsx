...
const SearchModal = ({ isSearchOpened, setIsSearchOpened }) => {
  return (
    <div className={`modal-search ${isSearchOpened ? 'show' : ''}`}>
      <div className="modal-wrapper">
        ...
        <i className="bi bi-x-circle" id="close-search" onClick={() => setIsSearchOpened(false)}></i>
      </div>
      <div className="modal-overlay" onClick={() => setIsSearchOpened(false)}></div>
    </div>
  )
}
